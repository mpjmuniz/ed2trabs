...
/*
TEST("Teste Classificacao Interna. Arquivo vazio deve criar p1.dat vazio");
if (!skip) {
...
TEST("Teste Selecao com Substituicao. Arquivo vazio deve criar p1.dat vazio");
if (!skip) {
	ListaClientes *entrada, *oraculo, *saida;
	Nomes *p;
...
TEST("Teste 5 Selecao com Substituicao. Exemplo visto em aula");
if (!skip) {
	ListaClientes *entrada, *oraculo, *saida;
	Nomes *p;
...
_TEST("Teste 3 Selecao Natural. Arquivo com 2 registros desordenados");
if (!skip) {
	ListaClientes *entrada, *oraculo, *saida;
	Nomes *p;
	entrada = cria_clientes(3,
...
_TEST("Teste 4 Selecao Natural. Arquivo com 6 registros desordenados");
if (!skip) {
	ListaClientes *entrada, *oraculo, *saida;
	Nomes *p;
	entrada = cria_clientes(7,
...
_TEST("Teste 5 Selecao Natural. Exemplo visto em aula");
if (!skip) {
	ListaClientes *entrada, *oraculo, *saida;
	Nomes *p;
	entrada = cria_clientes(55,
